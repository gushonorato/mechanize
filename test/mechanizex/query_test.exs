defmodule Mechanizex.CriteriaTest do
  use ExUnit.Case, async: true
  alias Mechanizex.Page.Element
  alias Mechanizex.Criteria
  doctest Mechanizex.Criteria
